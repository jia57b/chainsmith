#!/bin/bash
# start-multinode.sh — Start Cronos 4-validator localnet
#
# Prerequisites:
...
echo "🚀 Starting Cronos multi-validator localnet..."
...
if [ $WAITED -ge $MAX_WAIT ]; then
    ...
    echo "   1. docker compose --env-file .env.multinode -f docker-compose.yml logs cronos-validator1"
...
echo ""
echo "✅ Cronos multi-validator localnet started!"
echo ""
echo "📊 Network Status:"
echo "   Block Height:    ${HEIGHT}"
