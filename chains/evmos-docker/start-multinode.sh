#!/bin/bash
# start-multinode.sh — Start Evmos 4-validator localnet
#
# Prerequisites:
...
echo "🚀 Starting Evmos multi-validator localnet..."
...
if [ $WAITED -ge $MAX_WAIT ]; then
    ...
    echo "   1. docker compose --env-file .env.multinode -f docker-compose.yml logs evmos-validator1"
...
echo ""
echo "✅ Evmos multi-validator localnet started!"
echo ""
echo "📊 Network Status:"
echo "   Block Height:    ${HEIGHT}"
