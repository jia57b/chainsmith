#!/bin/bash
# start-multinode.sh — Start Kii 4-validator localnet
#
# Prerequisites:
...
echo "🚀 Starting Kii multi-validator localnet..."
...
if [ $WAITED -ge $MAX_WAIT ]; then
    ...
    echo "   1. Check logs:   docker compose --env-file .env.multinode -f docker-compose.multinode.yml logs kii-validator1"
...
echo ""
echo "✅ Kii multi-validator localnet started!"
echo ""
echo "📊 Network Status:"
echo "   Block Height:    ${HEIGHT}"
