#!/bin/bash
# start-multinode.sh — Start Mezo 4-validator localnet
#
# Prerequisites:
...
if [ ! -f "${TESTNET_DATA}/node0/mezod/config/genesis.json" ]; then
    echo "❌ testnet-data not found. Run ./init-multinode.sh first."
    exit 1
fi

echo "🚀 Starting Mezo multi-validator localnet..."
...
echo ""
echo "✅ Mezo multi-validator localnet started!"
echo ""
echo "📊 Network Status:"
echo "   Block Height:    ${HEIGHT}"
...
echo ""
echo "📍 Validator 0 Endpoints (primary):"
...
echo "   Validator 1:     RPC=:36657  REST=:21317  EVM=:28545"
echo "   Validator 2:     RPC=:46657  REST=:31317  EVM=:38545"
echo "   Validator 3:     RPC=:56657  REST=:41317  EVM=:48545"
echo ""
