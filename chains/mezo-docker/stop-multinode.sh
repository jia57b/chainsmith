#!/bin/bash
# stop-multinode.sh — Stop Mezo multi-validator localnet
#
# Usage:
...
echo "🛑 Stopping Mezo multi-validator localnet..."
...
if [ "$1" = "--clean" ]; then
    ...
    rm -rf "${SCRIPT_DIR}/testnet-data" 2>/dev/null || true
    echo "   ✅ Testnet data cleaned"
    echo "   Run ./init-multinode.sh to re-initialize"
fi

echo ""
echo "✅ Mezo multi-validator localnet stopped."
